...
public class tools {
	...
	*/
    ...
    /**
     * Экранирует специальные символы в имени файла, чтобы сделать его безопасным для использования в различных ОС.
     *
     * @param s Строка, представляющая имя файла.
     * @return Экранированное имя файла с замененными или удаленными специальными символами.
     */
    public static String escapeFileName(String s){
        return s.replaceAll("\\s+", "_").replaceAll("[^\\p{L}\\p{N}\\.\\-_]", "").replaceAll("^_+|_+$", "");
    }
